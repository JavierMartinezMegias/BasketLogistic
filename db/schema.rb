...
ActiveRecord::Schema[7.1].define(version: 2024_10_19_002932) do
  ...
  create_table "training_days", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["player_id"], name: "index_training_days_on_player_id"
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "players", "teams"
  add_foreign_key "training_days", "players"
end
